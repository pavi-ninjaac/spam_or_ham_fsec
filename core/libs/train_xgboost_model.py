...
from core.config.config_parser_file import XGBoostConfig
...
def train_xgboost():
    ...
    param: dict = asdict(XGBoostConfig())
    unique_run_name = get_unique_run_name(model_name="xgboost")
    ...
    backend_logger.info(f"Model training done for XGboost with parameters {param}")
