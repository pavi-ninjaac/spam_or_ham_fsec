...
from core.config.config_parser_file import RandomForestConfig
...
def train_random_forest():
    ...
    param: dict = asdict(RandomForestConfig())
    unique_run_name = get_unique_run_name(model_name="random_for")
    ...
    with mlflow.start_run(run_name=unique_run_name):
        ...
        mlflow.sklearn.log_model(model, artifact_path="RandomForest_model")

    backend_logger.info(f"Model training done for ranomd forest with parameters {param}")
